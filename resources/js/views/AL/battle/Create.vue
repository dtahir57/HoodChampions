	...
	<div class="main-wrapper">
	  <section class="edit-battle">
	    <div class="container">
	      <div class="row">
	        <div class="col-12">
	          <h1 class="common-h">CREATE new Battle</h1>
	        </div>
	      </div>
	      <div class="row"> 
	        <div class="col-lg-5 col-sm-6">
	          ...
	          <div class="form-group">
	            <label for="max-groups">Max Number of Teams</label>
	            <input type="number" name="Teams" v-model="data.max_no_of_members" v-validate="'required|numeric'" class="form-control">
        	...
        	if (!this.valid) {
        		...
        		.then(response => {
        			...
        			if (response.data.code == 200) {
        				this.$router.push({ name: 'BattleView', params: {id: response.data.battle.id} })
        			}
        		}).catch(error => {
