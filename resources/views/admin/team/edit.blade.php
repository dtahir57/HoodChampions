                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                <form action="{{ route('team.update', $team->id) }}" method="post" class="form" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" name="hood_id">
                                                                <optgroup label="Planning Area Name">
                                                                    ...
                                                                    <option value="{{ $hood->id }}" @if($team->hood_id = $hood->id) selected @endif>{{ $hood->planning_area_name }}</option>
                                                                    @endforeach
                                                                </optgroup>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" name="users[]" multiple="multiple">
                                                                <optgroup label="Planning Area Name">
                                                                    ...
                                                                    <option value="{{ $kaki->id }}" {{ in_array($kaki->id, $team->users()->pluck('user_id')->toArray()) ? 'selected' : '' }}>{{ $kaki->name }} | {{ $kaki->email }}</option>
                                                                    @endforeach
                                                                </optgroup>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="title" class="form-control" placeholder="Title" value="{{ $team->title }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="MaxNoOfPlayers">Max No. Of Players</label>
                                                            <input type="text" name="max_no_of_players" class="form-control" placeholder="Max No. Of Players" value="{{ $team->max_no_of_players }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="Email">Email</label>
                                                            <input type="text" name="email" class="form-control" placeholder="email" value="{{ $team->email }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="ContactNo">Contact No</label>
                                                            <input type="text" name="contact_no" class="form-control" placeholder="contact_no" value="{{ $team->contact_no }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="MeetupPlace">Meetup Place</label>
                                                            <input type="text" name="meetup_place" class="form-control" placeholder="Meetup Place" value="{{ $team->meetup_place }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="AboutUs">About Us</label>
                                                            <input type="text" name="about_us" class="form-control" placeholder="About Us" value="{{ $team->about_us }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="Description">Description</label>
                                                            <textarea class="form-control" name="description" placeholder="Description">{{ $team->description }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
