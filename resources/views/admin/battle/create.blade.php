            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <h4 class="card-title">Create Battle</h4>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                <form action="{{ route('battle.store') }}" method="post" class="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card">
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="max_no_of_teams" class="form-control" placeholder="Max No. Of Teams" value="{{ old('max_no_of_teams') }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
