...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "main-wrapper" }, [
      _c("section", { staticClass: "friend-profile" }, [
            ...
            _c("div", { staticClass: "col-lg-8 col-md-7" }, [
              _c("div", { staticClass: "about-profile" }, [
                ...
                _c("div", { staticClass: "block" }, [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "not-any" }, [
                    _c("p", [_vm._v("Joel Wong has not joined any Teams")]),
                    _vm._v(" "),
                    _c("button", { staticClass: "btn btn-default" }, [
                      _vm._v("Descover New Teams")
                    ])
                  ])
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "block" }, [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "not-any" }, [
                    _c("p", [_vm._v("Joel Wong has not joined any Battles")]),
                    _vm._v(" "),
                    _c("button", { staticClass: "btn btn-default" }, [
                      _vm._v("Descover New Battles")
                    ])
                  ])
                ])
              ])
